...
{   // File reading and writing
    public class FileHandler
    {
        ...
        public static Dictionary<string, Dictionary<string, string>> DictFromFile(string filename)
        {
            ...
            while (index < allLines.Length) // reading all the lines of the array
            {
                if (allLines[index].Contains("["))
                {
                    ...
                    index++;
                    section.Add("year", allLines[index].Replace("release_year=",null));
                    index++;
        ...
        /*public void DictToFile(Dictionary<string, Dictionary<string, string>> dataBase, string filename)
        {
            foreach (KeyValuePair<string, Directory<string, string>> record in dataBase)
            {
